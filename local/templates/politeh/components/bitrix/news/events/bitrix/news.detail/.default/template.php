...
<div class="events-top">
	...
	<div class="top-block-navigation">
		<a href="/events/" class="top-block-navigation__item active" id="all">Все события</a>
...
<div class="event-section">
    <div class="event-section-info">
      <div class="events-slider-item-left">
        <div class="events-slider-item__date">
          <span class="num"><?=strtolower(FormatDate("d", MakeTimeStamp($arResult['PROPERTIES']['DATE_EVENT_START']['VALUE']))) ?></span>
          <span class="mounth"><?=strtolower(FormatDate("F", MakeTimeStamp($arResult['PROPERTIES']['DATE_EVENT_START']['VALUE']))) ?></span>
        </div>
        <span class="year"><?=strtolower(FormatDate("Y", MakeTimeStamp($arResult['PROPERTIES']['DATE_EVENT_START']['VALUE']))) ?></span>
      </div>
      <div class="title">
        <h1><?=$arResult["NAME"]?></h1>
      </div>
	...
	<div class="event-section-actions">
		...
		<div class="event-section-actions-right">
			...
			<? } ?>
			<a href="javascript:;">Поделиться</a>
		</div>
	</div>
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "events_similar", Array(
